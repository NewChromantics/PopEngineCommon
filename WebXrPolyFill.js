...
/*
	...
	{
		const Position = {};
		Position.x = this.matrix[12] / this.matrix[15];
		Position.y = this.matrix[13] / this.matrix[15];
		Position.z = this.matrix[14] / this.matrix[15];
		return Position;
	}
...
{
	constructor(Session,OpenglContext)
	{
		//	gr: we should make a frame buffer here, blit camera to it for the current pose
...
const Module = {};
Module.XRRigidTransform = XRRigidTransform;
Module.XRWebGLLayer = XRWebGLLayer;
